 ...
 */
public class SoundAnalysisUpload extends AsyncTask<String, String, String>
{
    ...
    public SoundAnalysisUpload(Context context,UploadManager uploadManager)
    {
        upMan = uploadManager;
        t = context;
       // new UploadSoundFile().execute();
    }



    //class UploadSoundFile extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args)
        {
            ...
            if(userID != -1)
            {
                String[] fileData = getSoundAnalyisFileData();
                ...
                if(fileData != null && fileData.length > 0)
                {
                    ...
                    JSONObject json = jParser.makeHttpRequest(ConnectionInfo.url_soundFileAdd, "POST", params);
                    if(json != null)
                    {
                        try {
    ...
    public void Finish()
    {
        ...
        File fileToDel = new File(fullfilename, SoundFileProcessor.SOUND_FEATURES_SAVE_FILE_NAME_FOR_UPLOAD);
        if(fileToDel.exists())
        {
            fileToDel.delete();
        }
        ...
        protected String[] getSoundAnalyisFileData()
        {
            ...
            File fileToRead = new File(fullfilename, SoundFileProcessor.SOUND_FEATURES_SAVE_FILE_NAME_FOR_UPLOAD);
            try
            {
